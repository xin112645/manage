...
public class LogUtils {
    ...
    private static final int MESSAGE_MAX_LENGTH = 1024000;
    ...
    public static synchronized void setLogOutFile(String File) throws IOException {
    	SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String path="";
    	try {
            FileSystemView fsv = FileSystemView.getFileSystemView();
            path = fsv.getHomeDirectory()+"";
        }catch (Exception e){
    	    path="C:/Users/Administrator/Desktop";
    	    System.out.println("日志获取错误");
        }
        LogUtils.logOutFile = new File(path+"/log/"+File+"_"+simpleDateFormat.format(new Date())+".log");
